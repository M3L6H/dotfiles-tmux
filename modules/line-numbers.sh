...
# Original script from https://gist.github.com/Nimmidev/2cf4d5cc80dce32d0240ec7b3cfe090f
...
redraw_line_numbers() {
  ...
  printf "\e[38;2;%s;2m" "$COLOR_NUMBERS_RGB"
  seq "$cursor_line" -1 1
  printf "\e[0m"

  printf "\e[38;2;%s;1m 0\e[0m" "$COLOR_ACTIVE_NUMBER_RGB"
